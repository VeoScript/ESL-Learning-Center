    ...
    >
      <b-list-group>
        ...
        <b-list-group-item
          ...
          to="/about"
        >
          <b-icon icon="person-check"></b-icon> About
        </b-list-group-item>
        <b-list-group-item
          :class="$route.path === '/lessons' ? 'active' : ''"
          to="/lessons"
        >
          <b-icon icon="receipt"></b-icon> Lessons
        </b-list-group-item>
        <b-list-group-item
          :class="$route.path === '/teachers' ? 'active' : ''"
          to="/teachers"
        >
          <b-icon icon="people"></b-icon> Teachers
        </b-list-group-item>
        <b-list-group-item
          :class="$route.path === '/contacts' ? 'active' : ''"
          to="/contacts"
        >
          <b-icon icon="file-richtext"></b-icon> Contacts
        </b-list-group-item>
        <b-list-group-item
          to="/register"
...
.active {
  background: rgb(44, 204, 204) !important;
  border: none;
  color: white;
}
